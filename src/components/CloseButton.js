...
export default customElements.define('x-close-button', class extends LitElement {
    ...
    #toggleOpen(){
        ...
        document.querySelector("#app > x-aside").shadowRoot.querySelector("#aside").classList.toggle('aside-open')
    }
